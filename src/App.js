...
import Phase4 from './components/Phase4';  // NOW UNCOMMENTED
import Phase5 from './components/Phase5';  // NOW UNCOMMENTED
              ...
              element={
                ...
                >
                  {gameOver ? (
                    ...
                    <>
                      {/* Phase order: Phase 1 → Phase 4 → Phase 5 → Phase 6 */}
                      {currentPhase === 1 && <Phase1 proceed={() => setCurrentPhase(4)} loseLife={loseLife} />}
                      ...
                      {currentPhase === 6 && <Phase6 proceed={completeGame} loseLife={loseLife} />}
